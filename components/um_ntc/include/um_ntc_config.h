#ifndef UM_NTC_CONFIG_H
#define UM_NTC_CONFIG_H
...
/**
 * @brief Maximum number of NTC channels
 */
#define NTC_MAX_CHANNELS 2

    /**
     * @brief NTC channel configuration structure
     */
    typedef struct
    {
    ...
    /**
     * @brief Load NTC channel configurations from file
     *
    ...
    /**
     * @brief Save current NTC channel configurations to file
     *
     * @return esp_err_t ESP_OK on success, error code otherwise
     */
    ...
    /**
     * @brief Apply loaded configuration to NTC channels
     *
    ...
    /**
     * @brief Get NTC configuration as JSON string
     *
    ...
    /**
     * @brief Update configuration for a specific NTC channel
     *
    ...
    /**
     * @brief Get configuration for a specific NTC channel
     *
     * @param channel_id Channel ID (0 for CHANNEL_1, 1 for CHANNEL_2)
     * @return const um_ntc_channel_config_t* Pointer to configuration or NULL
     */
